...
<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=clawgod">
    <img src="./assets/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=clawgod)** provides free API credits for ClawGod users — access 59+ LLM models (Claude, GPT-5, Gemini, DeepSeek and more) through a single OpenAI-compatible endpoint. Set `ANTHROPIC_BASE_URL=https://api.atlascloud.ai/v1` in ClawGod's third-party API config to unlock powerful models without subscription limits — [coding plan](https://www.atlascloud.ai/console/coding-plan)

...
> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=clawgod)** は ClawGod ユーザーに無料 API クレジットを提供します — OpenAI 互換エンドポイントで 59 以上の LLM モデル（Claude、GPT-5、Gemini、DeepSeek など）にアクセスできます。ClawGod のサードパーティ API 設定で `ANTHROPIC_BASE_URL=https://api.atlascloud.ai/v1` を設定するだけで強力なモデルを利用可能 — [coding plan](https://www.atlascloud.ai/console/coding-plan)

<details>
<summary>Atlas Cloud の全 LLM モデル（59 個）</summary>
